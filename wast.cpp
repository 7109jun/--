// wastc_v5.cpp
// Single-file wast -> C++ transpiler.
// No external dependencies. C++17.
//
// Build:
//   g++ -std=c++17 -O3 -march=native -flto -funroll-loops wastc_v5.cpp -o wastc
//
// Usage:
...
os << "\n";
os << "  hint: wast syntax uses fn name(args) ( ... ), if cond ( ... ), match expr ( ... )";
return os.str();
}
...
// Generated by wastc v5.
// Embedded wast runtime: single-file, portable, C++17.
...
if (argc < 2) {
cerr << "wastc v5 - single-file wast -> C++ transpiler\n";
